# Generated by Django 4.2.3 on 2023-08-14 11:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.account', verbose_name='account')),
                ...
                ('vat_rate', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True, verbose_name='vat rate')),
                ...
                ('logo', models.ImageField(blank=True, null=True, upload_to=core.models.user_directory_path, verbose_name='logo')),
                ('signature', models.ImageField(blank=True, null=True, upload_to=core.models.user_directory_path, verbose_name='signature')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='core.account', verbose_name='account')),
                ('properties', models.ManyToManyField(blank=True, help_text='The properties this user has access.', related_name='users', related_query_name='user', to='core.property', verbose_name='properties')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('no_stats', models.BooleanField(default=False, help_text='Check to ignore from statistics bookings with this status')),
                ('finalized', models.BooleanField(default=True, help_text='If true, the booking is finalized and considered as real')),
                ("account", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="core.account", verbose_name="account")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, verbose_name='name')),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.account', verbose_name='account')),
                ('default_booking_status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='core.bookingstatus')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_price', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True, verbose_name='unit price VAT incl.')),
                ('vat', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True, verbose_name='VAT %')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('daily_rate', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True, verbose_name='daily rate')),
                ('weekend_rate', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True, verbose_name='weekend rate')),
                ('weekly_rate', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True, verbose_name='weekly rate')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('daily_rate', models.DecimalField(decimal_places=2, help_text='Default price for one night', max_digits=20, verbose_name='daily rate')),
                ('guaranty', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True, verbose_name='guaranty deposit')),
                ...
                ('tourist_tax', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True, verbose_name='tourist tax')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='core.bookingchannel')),
                ('begin_date', models.DateField(verbose_name='begin date')),
                ('end_date', models.DateField(verbose_name='end date')),
                ...
                ('daily_rate', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True, verbose_name='daily rate')),
                ('price', models.DecimalField(decimal_places=2, help_text='Total price, either computed by daily price or applying flat rate', max_digits=20, verbose_name='price')),
                ...
                ('guaranty', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True, verbose_name='guaranty')),
                ('commission_fees', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True, verbose_name='commission fees')),
                ('arrival_details', models.CharField(blank=True, help_text='Arrival time, flight number, etc...', max_length=100, null=True, verbose_name='arrival details')),
                ('notes', models.TextField(blank=True, null=True, verbose_name='Notes')),
                ('options', models.ManyToManyField(through="core.BookedService", to="core.service")),
                ('cancelled', models.BooleanField(default=False, help_text='True if this booking was cancelled', verbose_name='cancelled')),
                ('deleted', models.BooleanField(default=False, help_text='True if this booking was deleted', verbose_name='deleted')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "account",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="core.account", verbose_name="account"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('account', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='core.account', verbose_name='account')),
            ],
            options={
