"""Runtime logging configuration with hot-reload.

Vendored from the ``my-django-tweaks`` package (``my_django_tweaks.logging_config``),
which was otherwise unused and dragged in the abandoned django-rest-swagger / coreapi
dependency chain. Kept behaviour-identical.
"""
    ...
    def do_reconfigure_logging(self):
        ...
        if not log_ok:
            ...
            log_file = logging.handlers.RotatingFileHandler(
                os.path.join(self.log_path, os.path.basename(self.log_name) + '.log'),
