    ...
    if (this.state.uploading || this.state.successfulUploaded) {
      return (
        <div className="ProgressWrapper">
          <LinearProgress variant="determinate" value={uploadProgress ? uploadProgress.percentage : 0} />
          <CheckIcon
            alt="done"
            style={{
              opacity:
  ...
  render() {
    ...
    return (
      <div className="Upload">
        <span className="Title">{this.props.uploadLabel || t("Upload Files")}</span>
...
const Upload = withTranslation()(UploadClass);
